...
import { getCurrentTime, getDuration, getHovered, setCurrentTime, setHovered, setIsSeeking } from '../../redux/AudioSlice';

const HeroVinylControls = ({ audioRef }) => {
    ...
    return (
        <div
            className={`wrap mt-1 mb-3 ${hovered ? ' hover' : ''}`}
            onMouseEnter={handleMouseEnter}
            onMouseLeave={handleMouseLeave}
            onMouseUp={handleMouseUp}
            onMouseDown={handleMouseDown}
        >
            <div className="range-wrapper px-3">
                <div
...
export default HeroVinylControls;